...
class StrategyChain(object):
    ...
    def run(self, step, temperature):
        ...
        for j in range(self.energy_state.current_location.size * 2):
            ...
            ### ESTA LÍNEA ES LA QUE GENERA EL VECTOR A PROVAR EN EL SIGUIENTE PASO ###
