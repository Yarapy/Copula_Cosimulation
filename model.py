...
def variogram_combination( sv1, sv2, param1, param2, lags):
    '''
    Input:  (sv_model)  semivariogram function
                      - spherical
                      - exponential
                      - gaussian
            (sill)        sill variance
            (a_range)     correlation range
            (lags)   lag distances
    Output: (semfct) function modeling the semivariance
    '''
    def inner( h ):
        return sv1(h,*param1)+sv2(h,*param2)
    return inner
