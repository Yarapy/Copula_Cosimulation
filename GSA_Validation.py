...
##Well2Noruego 
#model='spherical';sill=0.00093;nugget_var=0.0004;a_range=110;amplitude=0;w0=[1,0.001]  
#BF3
...
maxiter=500 #25 iter para cualquier int_temp evalute 480,1 iter 23 callbak y 193 evalute 
#args
